# @@ whsiper_test2.py + wispermic_myself.py 합친거 @@
...
class RealTime_STT:
    def __init__(self,model="base",device=("cuda" if torch.cuda.is_available() else "cpu"),\
                 energy=300,pause=0.5,save_file=False,model_root="./whisper_model",mic_index=None):
        self.energy = energy
        self.pause = pause
...
class Whisper_STT_Agent(RealTime_STT):
